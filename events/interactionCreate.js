...
client.on("interactionCreate", async (interaction) => {
    ...
    if (interaction.isCommand()) {
      ...
      if (!cmd) return interaction.followUp({ content: "An error has occured!! Please Retry if not working join our support server! https://discord.gg/HyMvKMM96M" });
